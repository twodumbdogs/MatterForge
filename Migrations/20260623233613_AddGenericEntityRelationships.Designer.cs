...
namespace CMIForge.Migrations
{
    ...
    [Migration("20260623233613_AddGenericEntityRelationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMIForge.Models.ConflictSearchDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConflictSearchDocuments");
                });
            ...
            modelBuilder.Entity("CMIForge.Models.DashboardAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DashboardKey", "SecurityRoleId")
                        .IsUnique()
                        .HasFilter("[SecurityRoleId] IS NOT NULL");

                    b.HasIndex("DashboardKey", "TeamId")
                        .IsUnique()
                        .HasFilter("[TeamId] IS NOT NULL");

                    b.HasIndex("DashboardKey", "UserId")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL");

                    b.ToTable("DashboardAssignments");
                });
            ...
            modelBuilder.Entity("CMIForge.Models.EntityRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ToEntityType", "ToEntityId");

                    b.HasIndex("FromEntityType", "FromEntityId", "ToEntityType", "ToEntityId", "RelationshipTypeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CMIForge.Models.RelationshipType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsActive", "Scope", "Name");
            ...
            modelBuilder.Entity("CMIForge.Models.WorkflowNotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkflowNotificationTemplates");
                });
            ...
            modelBuilder.Entity("CMIForge.Models.EntityRelationship", b =>
                {
                    b.HasOne("CMIForge.Models.RelationshipType", "RelationshipType")
            ...
            modelBuilder.Entity("CMIForge.Models.WorkflowStep", b =>
                {
                    ...
                    b.HasOne("CMIForge.Models.WorkflowNotificationTemplate", "NotificationTemplate")
