...
namespace MatterForge.Migrations
{
    ...
    [Migration("20260617181644_AddTenantSignupAndDemoResetRuns")]
    partial class AddTenantSignupAndDemoResetRuns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatterForge.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MatterForge.Models.ImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatterForge.Models.ImportBatchRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatterForge.Models.SubmissionAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatterForge.Models.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MatterForge.Models.ConflictSearchResult", b =>
                {
                    b.HasOne("MatterForge.Models.MatterForgeUser", "ClearedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MatterForge.Models.ImportBatch", b =>
                {
                    b.HasOne("MatterForge.Models.MatterForgeUser", "ImportedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MatterForge.Models.ImportBatchRow", b =>
                {
                    b.HasOne("MatterForge.Models.ImportBatch", "ImportBatch")
                        .WithMany("Rows")
            ...
            modelBuilder.Entity("MatterForge.Models.SubmissionAttachment", b =>
                {
                    ...
                    b.HasOne("MatterForge.Models.MatterForgeUser", "UploadedByUser")
                        .WithMany()
